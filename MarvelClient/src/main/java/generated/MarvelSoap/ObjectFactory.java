 ...
 * generated in the generated.MarvelSoap package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetFilmsResponse_QNAME = new QName("http://Service.MarvelSoap.com/", "getFilmsResponse");
    private final static QName _Delete_QNAME = new QName("http://Service.MarvelSoap.com/", "delete");
    private final static QName _Add_QNAME = new QName("http://Service.MarvelSoap.com/", "add");
    private final static QName _GetFilmResponse_QNAME = new QName("http://Service.MarvelSoap.com/", "getFilmResponse");
    private final static QName _DeleteResponse_QNAME = new QName("http://Service.MarvelSoap.com/", "deleteResponse");
    private final static QName _Edit_QNAME = new QName("http://Service.MarvelSoap.com/", "edit");
    private final static QName _GetFilm_QNAME = new QName("http://Service.MarvelSoap.com/", "getFilm");
    private final static QName _GetFilms_QNAME = new QName("http://Service.MarvelSoap.com/", "getFilms");
    private final static QName _EditResponse_QNAME = new QName("http://Service.MarvelSoap.com/", "editResponse");
    private final static QName _AddResponse_QNAME = new QName("http://Service.MarvelSoap.com/", "addResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: generated.MarvelSoap
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Service.MarvelSoap.com/", name = "getFilmsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Service.MarvelSoap.com/", name = "delete")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Service.MarvelSoap.com/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Service.MarvelSoap.com/", name = "getFilmResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Service.MarvelSoap.com/", name = "deleteResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Service.MarvelSoap.com/", name = "edit")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Service.MarvelSoap.com/", name = "getFilm")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Service.MarvelSoap.com/", name = "getFilms")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Service.MarvelSoap.com/", name = "editResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Service.MarvelSoap.com/", name = "addResponse")
