 ...
 * generated in the generated.SonyClient package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetFilmsResponse_QNAME = new QName("http://Service.SonySoap.com/", "getFilmsResponse");
    private final static QName _Delete_QNAME = new QName("http://Service.SonySoap.com/", "delete");
    private final static QName _GetFilmResponse_QNAME = new QName("http://Service.SonySoap.com/", "getFilmResponse");
    private final static QName _Add_QNAME = new QName("http://Service.SonySoap.com/", "add");
    private final static QName _AddResponse_QNAME = new QName("http://Service.SonySoap.com/", "addResponse");
    private final static QName _EditResponse_QNAME = new QName("http://Service.SonySoap.com/", "editResponse");
    private final static QName _DeleteResponse_QNAME = new QName("http://Service.SonySoap.com/", "deleteResponse");
    private final static QName _Edit_QNAME = new QName("http://Service.SonySoap.com/", "edit");
    private final static QName _GetFilm_QNAME = new QName("http://Service.SonySoap.com/", "getFilm");
    private final static QName _GetFilms_QNAME = new QName("http://Service.SonySoap.com/", "getFilms");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: generated.SonyClient
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Service.SonySoap.com/", name = "getFilmsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Service.SonySoap.com/", name = "delete")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Service.SonySoap.com/", name = "getFilmResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Service.SonySoap.com/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Service.SonySoap.com/", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Service.SonySoap.com/", name = "editResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Service.SonySoap.com/", name = "deleteResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Service.SonySoap.com/", name = "edit")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Service.SonySoap.com/", name = "getFilm")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Service.SonySoap.com/", name = "getFilms")
